...
#pragma omp parallel for shared(Res, big_unified)                    // big matrix Res is only useful for detailed statistics
	...
	nam_res  = "direct_resq-"  + fil1 + "Ral" + fil2 + ".txt";
	nam_comp = "direct_compq-" + fil1 + "Ral" + fil2 + ".txt";
	nam_stat = "direct_statq-" + fil1 + "Ral" + fil2 + ".txt";
...
{
	quadfloat w[6],v[6],nf[6],sf;   
	quadfloat nv[6],h,h3,cof=2.250;
	unsigned long i;
    int j,m;
